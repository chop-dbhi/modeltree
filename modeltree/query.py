...
from modeltree.exceptions import (ModelDoesNotExist, ModelNotRelated,
        ModelNotUnique, InvalidLookup)
from modeltree.tree import trees


def _resolve(app_name=None, model_name=None, field_name=None, operator=None, tree=None):
